...
<!--      <input type="text" name="emp_idddpp" placeholder="Employee Phone"><br><br>-->
      <input type="submit" name="logoinnnmmpemp" value="Button"><br>
      </div>
         <div class="col-md-6 form-group">
      <h4>Change Email Address</h4>
      <input type="text" name="emp_idddq" placeholder="Employee Id">
      <input type="email" name="emp_idddqq" placeholder="Employee Email">
      <input type="submit" name="logoinnnmmqemp" value="Button"><br>
      </div>
      </div>
      ...
      <input type="submit" name="logoinnnmmpempd" value="Button"><br>
      </div>
         <div class="col-md-6 form-group">
      ...
      <input type="submit" name="logoinnnmmqempd" value="Button"><br>
      </div>
      </div>
  </form>
      <br>
