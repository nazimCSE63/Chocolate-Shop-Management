...
$t = 1025;
if(isset($_POST['logoinnorder'])){
      $t = 2025; 
 }else{}

if(isset($_POST['logoinnnmorder'])){
      $t = 2525; 
 }else{}

if(isset($_POST['logoinnnorder'])){
         $order_name = $_POST['order_name'];
         $order_addr = $_POST['order_address'];
         $order_phone = $_POST['order_phone'];
       $insertion = "insert into order_table values('$order_name','$order_addr','$order_phone') ";
       mysqli_query($con,$insertion);
 }else{}

if(isset($_POST['logoinnnmmuorder'])){
         $orderr_iddd = $_POST['Orderu_iddd'];
       $insertion = "delete from order_table where or_id='$orderr_iddd'";
       mysqli_query($con,$insertion);
 }else{}
...
<!--    <section class="site-cover" style="background-image: url(images/n1.jpg);" id="section-home">-->
  <section class="site-cover" style="background-color: white" id="section-home">
      <div class="container">
       ...
       <a style="margin-right:15px;" href="employee.php">Employee</a>
       <a style="margin-right:15px;" href="employeepro.php">Product</a>
       <a style="margin-right:15px;" href="employeeuse.php">User</a>
       <a style="margin-right:15px;" href="employeeord.php">Order</a>
       <a href="logout.php">Logout</a>
       </div><br><br>
       <h2 align="center">Order Information</h2><br>
        
      <form action="employeeord.php" method="post">
      <input type="submit" name="logoinnorder" value="Details Show Button">
      <input type="submit" name="logoinnnmorder" value="Refresh Page Button"><br><br>
      
      
      <h4>Insert Order</h4>
      <input type="text" name="order_name" placeholder="Product Id">
      <input type="text" name="order_address" placeholder="Product Price">
      <input type="text" name="order_phone" placeholder="Order User">
<!--
      <input type="email" name="user_email" placeholder="User Email">
      <input type="password" name="user_pass" placeholder="User Password">
-->
      <input type="submit" name="logoinnnorder" value="Insert Button"><br><br>
   
      
   
       <h4>Delete Order</h4>
      <input type="text" name="Orderu_iddd" placeholder="Order Id">
      <input type="submit" name="logoinnnmmuorder" value="Delete Button"><br><br>
...
<!--
      ...
      <input type="text" name="pro_idddp" placeholder="pro_id">
      <input type="text" name="pro_idddpp" placeholder="pro_Price">
      <input type="submit" name="logoinnnmmp" value="Update Button"><br>
      </div>
         <div class="col-md-6 form-group">
      <h4>Update Product Count</h4>
      <input type="text" name="pro_idddq" placeholder="pro_id">
      <input type="text" name="pro_idddqq" placeholder="pro_Count">
...
-->
    ...
    <table align="center" border="1px" style="width:600px; line-height:40px;" >
      <tr>
          <th colspan="3"><h2 align="center">Order record</h2></th>
      </tr>
      <t>
          <th>Order Id</th>
          <th>Order Price</th>
    ...
    if ($t == 2025) {
           ...
           while($rows=$result-> fetch_assoc())
       {
          ?>
          <tr>
              <td><?php echo $rows['or_id']; ?></td>
              <td><?php echo $rows['or_price']; ?></td>
              <td><?php echo $rows['or_user']; ?></td>
          </tr> 
          <?php   
       }
