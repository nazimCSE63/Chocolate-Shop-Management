...
if(isset($_POST['logoinnnuser'])){
         $user_name = $_POST['user_name'];
         $user_addr = $_POST['user_address'];
         $user_phone = $_POST['user_phone'];
         $user_email = $_POST['user_email'];
         $user_pass = md5($_POST['user_pass']);
       $insertion = "insert into user values('$user_name','$user_addr','$user_phone','$$user_email','$user_pass') ";
       mysqli_query($con,$insertion);
 }else{}

if(isset($_POST['logoinnnmmusere'])){
         $user_iddd = $_POST['user_iddd'];
       $insertion = "delete from user where email='$user_iddd'";
       mysqli_query($con,$insertion);
 }else{}
...
<!--    <section class="site-cover" style="background-image: url(images/n1.jpg);" id="section-home">-->
  <section class="site-cover" style="background-color: white" id="section-home">
      ...
      <form action="employeeuse.php" method="post">
      ...
      <input type="submit" name="logoinnnuser" value="Insert Button"><br><br>
   
      
   
       <h4>Delete User</h4>
      <input type="email" name="user_iddd" placeholder="User Email">
      <input type="submit" name="logoinnnmmusere" value="Delete Button"><br><br>
...
-->
    ...
    <table align="center" border="1px" style="width:600px; line-height:40px;" >
      <tr>
          <th colspan="4"><h2 align="center">User record</h2></th>
      </tr>
      <t>
          <th>User Name</th>
          <th>User Address</th>
