                    ...
                    <form action="main.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <!-- START: FORM-1 SECTION -->
                                <div class="form-1">
                                    <input type="password" id="mail" name="pass" required autocomplete="off" />
...
<!--                           <input type="submit" class="button-text button-contact" name="login" value="Login">-->
                            <button name="login" class="button-text button-contact">Log In</button> <br>
                            <a href="signupp.php"><h5 align="center">Create Account</h5></a>
<!--
                            <a href="signupp.php">
                            <button name="login" class="button-text button-contact">Create Account</button> 
                            </a>
-->
                        </div>
