...
$t = 1023;
if(isset($_POST['logoinnuser'])){
      $t = 2023; 
 }else{}

if(isset($_POST['logoinnnmuser'])){
      $t = 2523; 
 }else{}

if(isset($_POST['logoinnnorder'])){
         $order_name = $_POST['Order_iddd'];
         $order_addr = $_POST['Order_Pricee'];
         $orderr_phone =$_SESSION['User'];
       
       $insertion = "insert into order_table values('$order_name','$order_addr','$orderr_phone') ";
       mysqli_query($con,$insertion);

 }else{}

if(isset($_POST['logoinnnmmorder'])){
//         $user_idorderr = $_POST['user_idorder'];
//       $insertion = "select * from pro_table where Pro_Id='$user_idorderr'";
       $insertion = "select * from pro_table";
       mysqli_query($con,$insertion);
     $t = 2023; 
 }else{}
...
<!--    <section class="site-cover" style="background-image: url(images/n1.jpg);" id="section-home">-->
  <section class="site-cover" style="background-color: white" id="section-home">
      <div class="container">
       ...
       <a href="person.php">Back Page</a>
    
       </div><br><br>
<!--       <h2 align="center">Order Page</h2><br>-->
        
      <form action="orderpage.php" method="post">
<!--
      <input type="submit" name="logoinnuser" value="Details Show Button">
      <input type="submit" name="logoinnnmuser" value="Refresh Page Button"><br><br>
-->
      
      
      <h2 align="center">Order Information</h2>
      <h5>Enter Product Id</h5><input type="text" name="Order_iddd" placeholder="Product ID"><br><br>
      <h5>Enter Product Price</h5><input type="text" name="Order_Pricee" placeholder="Product Price">
<!--
...
-->
     <br><br>
      <input type="submit" name="logoinnnorder" id="register" value="Submit Button"><br><br>
   
      
      
      
       <h4>Product List Show</h4>
      
<!--      <input type="text" name="user_idorder" placeholder="Product Id">-->
     
      <input type="submit" name="logoinnnmmorder" value="Show Product">
       <input type="submit" name="logoinnnmuser" value="Refresh Button"><br><br>
...
-->
    ...
    <table align="center" border="1px" style="width:600px; line-height:40px;" >
      <tr>
          <th colspan="3"><h2 align="center">Product Table</h2></th>
      </tr>
      <t>
          <th>Product ID</th>
          <th>Product Name</th>
