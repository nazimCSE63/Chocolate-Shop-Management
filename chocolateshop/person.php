      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="site-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a href="#section-home" class="nav-link">User_Page</a></li>
<!--
...
<!--            <li class="nav-item"><a href="#section-gallery" class="nav-link">Manager</a></li>-->
    ...
    <section class="site-cover" style="background-image: url(images/n3.jpg);" id="section-home">
<!--  <section class="site-cover" style="background-color: Salmon" id="section-home">-->
      <div class="container">
        <div class="row align-items-center justify-content-center text-center site-vh-100">
          <div class="col-md-12">
            <h1 class="site-heading site-animate mb-3"></h1> 
              
<!--             <h3>Welcome To Costomer</h3>-->
                  <h1 style="color:blue;"><?php
    session_start();
 
    if(isset($_SESSION['User']))
    {
       echo ' Welcome To ' . $_SESSION['User'].'<br/>';
    }
    else
    {
              ...
              <div class="item">
                <div class="media d-block mb-4 text-center site-media site-animate border-0">
                  ...
                  <div class="media-body p-md-5 p-4">
                    ...
                    <p class="mb-0"><a href="orderpage.php" class="btn btn-primary btn-sm">Order Now!</a></p>
                  </div>
                </div>
              </div>
